...
/*NIE*/
--DROP TABLE IF EXISTS `tbl_nca_produce`;
--CREATE TABLE `tbl_nca_produce` (
...
--);
--
--DROP TABLE IF EXISTS `tbl_nca_producemateriel`;
--CREATE TABLE `tbl_nca_producemateriel` (
...
--);
--
--DROP TABLE IF EXISTS `tbl_nca_produceprocess`;
--CREATE TABLE `tbl_nca_produceprocess` (
...
--);
--
--DROP TABLE IF EXISTS `tbl_nca_orderproductplan`;
--CREATE TABLE `tbl_nca_orderproductplan` (
