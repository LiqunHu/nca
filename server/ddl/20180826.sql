...
ALTER TABLE tbl_nca_projectdetail ADD COLUMN space_state INTEGER NUll DEFAULT '0';
ALTER TABLE tbl_nca_projectdetail ADD COLUMN space_examine varchar(100) NUll DEFAULT '';
ALTER TABLE tbl_nca_projectdetail ADD COLUMN space_examine_time datetime(4) NUll ;
ALTER TABLE tbl_nca_projectdetail ADD COLUMN space_refuse_remark varchar(300) NUll DEFAULT '';
ALTER TABLE tbl_nca_project ADD COLUMN project_check_state INTEGER NUll;

DROP TABLE IF EXISTS `tbl_nca_project`;
CREATE TABLE `tbl_nca_project` (
...
DROP TABLE IF EXISTS `tbl_nca_projectconsumedetail`;
CREATE TABLE `tbl_nca_projectconsumedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_projectcost`;
CREATE TABLE `tbl_nca_projectcost` (
...
DROP TABLE IF EXISTS `tbl_nca_projectpurchaseorder`;
CREATE TABLE `tbl_nca_projectpurchaseorder` (
...
DROP TABLE IF EXISTS `tbl_nca_projectpurchaseorderdetail`;
CREATE TABLE `tbl_nca_projectpurchaseorderdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_projectreceive`;
CREATE TABLE `tbl_nca_projectreceive` (
...
DROP TABLE IF EXISTS `tbl_nca_projectreceivedetail`;
CREATE TABLE `tbl_nca_projectreceivedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_projectsubscribe`;
CREATE TABLE `tbl_nca_projectsubscribe` (
...
DROP TABLE IF EXISTS `tbl_nca_projectsubscribeorder`;
CREATE TABLE `tbl_nca_projectsubscribeorder` (
...
DROP TABLE IF EXISTS `tbl_nca_projectsubscribeorderdetail`;
CREATE TABLE `tbl_nca_projectsubscribeorderdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_projectsubscribeorderdetailend`;
CREATE TABLE `tbl_nca_projectsubscribeorderdetailend` (
...
DROP TABLE IF EXISTS `tbl_nca_projectbudget`;
CREATE TABLE `tbl_nca_projectbudget` (
