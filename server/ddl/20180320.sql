...
/* ls */
	...
	DROP TABLE IF EXISTS `tbl_nca_customer_contract`;
	DROP TABLE IF EXISTS `tbl_nca_customer_work_experience`;

	DROP TABLE IF EXISTS `tbl_nca_customercontract`;
    CREATE TABLE `tbl_nca_customercontract` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_customerworkexperience`;
    CREATE TABLE `tbl_nca_customerworkexperience` (
...
/* ty */
ALTER TABLE `tbl_nca_return`
ADD COLUMN `domain_id` bigint(20) NULL AFTER `return_refuse_remark`;

ALTER TABLE `tbl_nca_qualitycheckdetail`
