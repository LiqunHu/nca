...
DROP TABLE IF EXISTS `tbl_nca_specialexpense`;
CREATE TABLE `tbl_nca_specialexpense` (
...
call Pro_AddMenu('行政办公管理', '特殊费用报销', '/nca/baseconfig/NCASpecialExpenseControl', 'NCASPECIALEXPENSECONTROL');

/*end cici */

/* ty */
ALTER TABLE tbl_nca_docdetail MODIFY COLUMN clause_no varchar(50);
/*end ty */