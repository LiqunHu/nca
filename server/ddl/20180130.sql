...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_stockoutapplydetail`;
CREATE TABLE `tbl_nca_stockoutapplydetail` (
...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_stockoutapply`;
CREATE TABLE `tbl_nca_stockoutapply` (
...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_otherstockout`;
CREATE TABLE `tbl_nca_otherstockout` (
...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_stockotherapplyout`;
CREATE TABLE `tbl_nca_stockotherapplyout` (
