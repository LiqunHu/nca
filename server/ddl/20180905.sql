...
DROP TABLE IF EXISTS `tbl_nca_productivetaskdetail`;
CREATE TABLE `tbl_nca_productivetaskdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_productivetaskrelated`;
CREATE TABLE `tbl_nca_productivetaskrelated` (
