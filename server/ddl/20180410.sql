...
/* ls */
    ...
    DROP TABLE IF EXISTS `tbl_nca_meetingfollow`;
    CREATE TABLE `tbl_nca_meetingfollow` (
    ...
    call Pro_AddMenu('行政办公管理', '会议记录', '/nca/baseconfig/NCAMeetingMinuteControl', 'NCAMEETINGMINUTECONTROL');
