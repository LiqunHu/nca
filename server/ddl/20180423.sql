...
/* ls */
    DROP TABLE IF EXISTS `tbl_nca_document`;
    CREATE TABLE `tbl_nca_document` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_docdetail`;
    CREATE TABLE `tbl_nca_docdetail` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_docdetailuser`;
    CREATE TABLE `tbl_nca_docdetailuser` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_docdetailquestion`;
    CREATE TABLE `tbl_nca_docdetailquestion` (
    ...
    call Pro_AddMenu('行政办公管理', '文控管理', '/nca/baseconfig/NCADocumentManagementControl', 'NCADOCUMENTMANAGEMENTCONTROL');
