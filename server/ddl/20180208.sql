...
/* ty */
call Pro_AddMenu('运营数据管理', '人工价格标准', '/nca/baseconfig/NCAWorkerPriceControl', 'NCAWORKERPRICECONTROL');

DROP TABLE IF EXISTS `tbl_nca_workerprice`;
CREATE TABLE `tbl_nca_workerprice` (
...
ALTER TABLE `tbl_nca_stockapply`
