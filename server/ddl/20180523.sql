...
/*update tbl_common_systemmenu set systemmenu_name = '入库流水' where api_function = 'NCABUYINHISTORYCONTROL';*/
/*update tbl_common_templatemenu set templatemenu_name = '入库流水' where api_function = 'NCABUYINHISTORYCONTROL';*/
/*end ty */
