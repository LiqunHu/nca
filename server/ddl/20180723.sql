...
DROP TABLE IF EXISTS `tbl_nca_receipt`;
CREATE TABLE `tbl_nca_receipt` (
...
DROP TABLE IF EXISTS `tbl_nca_receiptitem`;
CREATE TABLE `tbl_nca_receiptitem` (
...
call Pro_AddMenu('WMS系统管理', '收货单列表','/nca/inventorymanage/NCAReceiptListControl','NCARECEIPTLISTCONTROL');
