...
/* ls */
call Pro_AddMenu('运营数据管理', '公告管理', '/nca/baseconfig/NCANoticeControl', 'NCANOTICECONTROL');
...
CREATE TABLE `tbl_nca_projectdetail` (
...
CREATE TABLE `tbl_nca_projectspacedetail` (
