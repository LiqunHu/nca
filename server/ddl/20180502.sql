...
/* ls */
DROP TABLE IF EXISTS `tbl_nca_corporateclients`;
CREATE TABLE `tbl_nca_corporateclients` (
...
update tbl_common_systemmenu set systemmenu_name='体验店管理' where api_function='NCABUSINESSCUSTOMERCONTROL';
...
call Pro_AddMenu('企业客户管理', '企业客户列表', '/nca/baseconfig/NCACorporateClientsControl', 'NCACORPORATECLIENTSCONTROL');
