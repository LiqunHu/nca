...
/* ls */
    DROP TABLE IF EXISTS `tbl_nca_askforleave`;
    CREATE TABLE `tbl_nca_askforleave` (
    ...
    call Pro_AddMenu('行政办公管理', '请假管理', '/nca/baseconfig/NCAAskForLeaveControl', 'NCAASKFORLEAVECONTROL');
