...
/* NJC */
call Pro_AddMenu('运营数据管理', '基础数据管理', '/nca/baseconfig/NCABaseDataControl', 'NCABASEDATACONTROL');
/*end NJC */
...
/* ls */
    ...
    DROP TABLE IF EXISTS `tbl_nca_meetingroom`;
    CREATE TABLE `tbl_nca_meetingroom` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_meetingroomequipment`;
    CREATE TABLE `tbl_nca_meetingroomequipment` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_vehicle`;
    CREATE TABLE `tbl_nca_vehicle` (
    ...
    call Pro_AddMenu('行政办公管理', '会议室维护', '/nca/baseconfig/NCAMeetingRoomControl', 'NCAMEETINGROOMCONTROL');
    call Pro_AddMenu('行政办公管理', '车辆维护', '/nca/baseconfig/NCAVehicleControl', 'NCAVEHICLECONTROL');

/*end ls */



DROP TABLE IF EXISTS `tbl_nca_reimburserank`;
CREATE TABLE tbl_nca_reimburserank
(
...
call Pro_AddMenu('行政办公管理', '报销职级维护', '/nca/baseconfig/NCAReimburseRankControl', 'NCAREIMBURSERANKCONTROL');

/* jjs */
INSERT INTO `seqmysql` VALUES ('idleApplyIDSeq', '0', '1', '99999999');
ALTER TABLE `tbl_nca_stockmap` ADD COLUMN `trigger_idle_scan` varchar(4) DEFAULT 0 AFTER `trigger_safe_model`;
/*end jjs */
