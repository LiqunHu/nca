...
/* ty */
ALTER TABLE `tbl_nca_fixedassetscheckdetail` ADD COLUMN `fixedassetscheck_acceptance` varchar(4) AFTER `scrap_flag`;
/*end ty */

/* ls */
DROP TABLE IF EXISTS `tbl_nca_fixedassetsrepair`;
CREATE TABLE `tbl_nca_fixedassetsrepair` (
...
DROP TABLE IF EXISTS `tbl_nca_fixedassetsrepairmaterials`;
CREATE TABLE `tbl_nca_fixedassetsrepairmaterials` (
