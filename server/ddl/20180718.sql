...
/* ls */
ALTER TABLE `tbl_nca_consumablesdetail`
...
call Pro_AddMenu('长期资产管理', '研发项目管理','/nca/longtermassets/NCADevelopControl','NCADEVELOPCONTROL');
call Pro_AddMenu('长期资产管理', '研发项目管理明细','/nca/longtermassets/NCADevelopDetailControl','NCADEVELOPDETAILCONTROL');
...
DROP TABLE IF EXISTS `tbl_nca_develop`;
CREATE TABLE `tbl_nca_develop` (
...
DROP TABLE IF EXISTS `tbl_nca_developbudget`;
CREATE TABLE `tbl_nca_developbudget` (
...
DROP TABLE IF EXISTS `tbl_nca_developconsume`;
CREATE TABLE `tbl_nca_developconsume` (
...
DROP TABLE IF EXISTS `tbl_nca_developconsumedetail`;
CREATE TABLE `tbl_nca_developconsumedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_developcost`;
CREATE TABLE `tbl_nca_developcost` (
...
DROP TABLE IF EXISTS `tbl_nca_developpurchaseorder`;
CREATE TABLE `tbl_nca_developpurchaseorder` (
...
DROP TABLE IF EXISTS `tbl_nca_developpurchaseorderdetail`;
CREATE TABLE `tbl_nca_developpurchaseorderdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_developreceive`;
CREATE TABLE `tbl_nca_developreceive` (
...
DROP TABLE IF EXISTS `tbl_nca_developreceivedetail`;
CREATE TABLE `tbl_nca_developreceivedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_developsubscribe`;
CREATE TABLE `tbl_nca_developsubscribe` (
...
DROP TABLE IF EXISTS `tbl_nca_developsubscribeorder`;
CREATE TABLE `tbl_nca_developsubscribeorder` (
...
DROP TABLE IF EXISTS `tbl_nca_developsubscribeorderdetail`;
CREATE TABLE `tbl_nca_developsubscribeorderdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_developsubscribeorderdetailend`;
CREATE TABLE `tbl_nca_developsubscribeorderdetailend` (
