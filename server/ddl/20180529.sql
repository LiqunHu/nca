...
/* ls */
DROP TABLE IF EXISTS `tbl_nca_fixedassetspurch`;
CREATE TABLE `tbl_nca_fixedassetspurch` (
...
DROP TABLE IF EXISTS `tbl_nca_fixedassetspurchdetail`;
CREATE TABLE `tbl_nca_fixedassetspurchdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_fixedassetscheck`;
CREATE TABLE `tbl_nca_fixedassetscheck` (
...
DROP TABLE IF EXISTS `tbl_nca_fixedassetscheckdetail`;
CREATE TABLE `tbl_nca_fixedassetscheckdetail` (
...
call Pro_AddMenu('长期资产管理', '固定资产管理', '/nca/longtermassets/NCAFixedAssetsControl', 'NCAFIXEDASSETSCONTROL');
