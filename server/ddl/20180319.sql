...
/* ls */
    ...
    CREATE TABLE `tbl_nca_customer_contract` (
    ...
    CREATE TABLE `tbl_nca_customer_work_experience` (
...
/* ty */
ALTER TABLE `tbl_nca_customer_contract`
ADD COLUMN `contract_state` varchar(100) DEFAULT '' AFTER `bank_account`;

call Pro_AddMenu('品质管理', '退货单', '/nca/purchasemanage/NCAReturnNoteControl', 'NCARETURNNOTECONTROL');
