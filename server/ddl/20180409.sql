...
/* ls */
    ...
    DROP TABLE IF EXISTS `tbl_nca_meeting`;
    CREATE TABLE `tbl_nca_meeting` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_meetingequipment`;
    CREATE TABLE `tbl_nca_meetingequipment` (
    ...
    DROP TABLE IF EXISTS `tbl_nca_meetingattendee`;
    CREATE TABLE `tbl_nca_meetingattendee` (
    ...
    call Pro_AddMenu('行政办公管理', '会议管理', '/nca/baseconfig/NCAMeetingManageControl', 'NCAMEETINGMANAGECONTROL');
...
-- 交通接待申请
 DROP TABLE IF EXISTS `tbl_nca_transreceptionapply`;
CREATE TABLE tbl_nca_transreceptionapply
(
