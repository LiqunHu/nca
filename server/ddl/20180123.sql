...
INSERT INTO `tbl_nca_taskallot` VALUES ('10', '入库申请', '分配入库申请审核人员', '1', '0', '2017-12-06 09:40:21', '2017-12-06 09:40:24');

/*end ty */


/* cici */
DROP TABLE IF EXISTS `tbl_nca_sitecase`;
CREATE TABLE `tbl_nca_sitecase` (
