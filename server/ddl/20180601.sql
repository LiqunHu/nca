...
call Pro_AddMenu('长期资产管理', '待摊资产项目管理','/nca/longtermassets/NCAAmortizeControl','NCAAMORTIZECONTROL');
call Pro_AddMenu('长期资产管理', '待摊资产项目管理明细','/nca/longtermassets/NCAAmortizeDetailControl','NCAAMORTIZEDETAILCONTROL');
call Pro_AddMenu('长期资产管理', '资产物料收料单', '/nca/longtermassets/NCAAmortizeReceiveControl','NCAAMORTIZERECEIVECONTROL');
call Pro_AddMenu('长期资产管理', '资产物料耗用单', '/nca/longtermassets/NCAAmortizeConsumeControl','NCAAMORTIZECONSUMECONTROL');
call Pro_AddMenu('长期资产管理', '待摊资产数据管理', '/nca/longtermassets/NCAAmortizeDataControl','NCAAMORTIZEDATACONTROL');
...
DROP TABLE IF EXISTS `tbl_nca_amortize`;
CREATE TABLE `tbl_nca_amortize` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizebudget`;
CREATE TABLE `tbl_nca_amortizebudget` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizeconsume`;
CREATE TABLE `tbl_nca_amortizeconsume` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizeconsumedetail`;
CREATE TABLE `tbl_nca_amortizeconsumedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizecost`;
CREATE TABLE `tbl_nca_amortizecost` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizereceive`;
CREATE TABLE `tbl_nca_amortizereceive` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizereceivedetail`;
CREATE TABLE `tbl_nca_amortizereceivedetail` (
...
DROP TABLE IF EXISTS `tbl_nca_amortizesubscribe`;
CREATE TABLE `tbl_nca_amortizesubscribe` (
