...
/* ls */
ALTER TABLE `tbl_nca_purchaseorder`
ADD COLUMN `check_state` varchar(4) NUll DEFAULT '0' AFTER `approval_date`;

ALTER TABLE `tbl_nca_purchasedetail`
ADD COLUMN `qualified_number` int(11) NUll DEFAULT 0 AFTER `order_ids`;

DROP TABLE IF EXISTS `tbl_nca_qualitycheck`;
CREATE TABLE `tbl_nca_qualitycheck` (
...
DROP TABLE IF EXISTS `tbl_nca_qualitycheckdetail`;
CREATE TABLE `tbl_nca_qualitycheckdetail` (
...
DROP TABLE IF EXISTS `tbl_nca_return`;
CREATE TABLE `tbl_nca_return` (
...
DROP TABLE IF EXISTS `tbl_nca_returndetail`;
CREATE TABLE `tbl_nca_returndetail` (
