...
/* wj */
DROP TABLE IF EXISTS `tbl_nca_consumables`;
CREATE TABLE `tbl_nca_consumables` (
...
DROP TABLE IF EXISTS `tbl_nca_consumablesdetail`;
CREATE TABLE `tbl_nca_consumablesdetail` (
...
call Pro_AddMenu('长期资产管理', '低值易耗品管理', '/nca/longtermassets/NCAConsumablesControl', 'NCACONSUMABLESCONTROL');
...
/* ty */
ALTER TABLE tbl_nca_fixedassetscheckdetail MODIFY COLUMN residual_value_rate double NUll DEFAULT '0';
/*end ty */

/* ls */
DROP TABLE IF EXISTS `tbl_nca_longassetsscrap`;
CREATE TABLE `tbl_nca_longassetsscrap` (
...
call Pro_AddMenu('长期资产管理', '资产报废管理', '/nca/longtermassets/NCAAssetRetirementControl', 'NCAASSETRETIREMENTCONTROL');
