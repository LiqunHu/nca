...
/*ty*/
DROP TABLE IF EXISTS `tbl_nca_otherinventoryorder`;
CREATE TABLE `tbl_nca_otherinventoryorder` (
...
DROP TABLE IF EXISTS `tbl_nca_otherinventoryaccount`;
CREATE TABLE `tbl_nca_otherinventoryaccount` (
