...
/* cici */
   DROP TABLE IF EXISTS `tbl_nca_trafficreceptionexpense`;
   CREATE TABLE `tbl_nca_trafficreceptionexpense` (
   ...
   DROP TABLE IF EXISTS `tbl_nca_trafficreceptionexpensedetail`;
   CREATE TABLE `tbl_nca_trafficreceptionexpensedetail` (
    ...
    call Pro_AddMenu('行政办公管理', '交通接待报销申请', '/nca/baseconfig/NCATransReceptionListExpenseControl', 'NCATRANSRECEPTIONLISTEXPENSECONTROL');
