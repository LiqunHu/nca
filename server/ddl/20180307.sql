...
/* ls */
DROP TABLE IF EXISTS `tbl_nca_humanresource`;
CREATE TABLE `tbl_nca_humanresource` (
...
call Pro_AddMenu('人力资源管理', '人力需求管理', '/nca/baseconfig/NCAHumanResourceControl', 'NCAHUMANRESOURCECONTROL');
