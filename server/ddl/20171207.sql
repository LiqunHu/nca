...
/*bb*/
/*ALTER TABLE `tbl_nca_orderdesign`
...
--DROP TABLE IF EXISTS `tbl_nca_process`;
--CREATE TABLE `tbl_nca_process` (
...
/* ty */
--DROP TABLE IF EXISTS `tbl_nca_reviewmateriel`;
--CREATE TABLE `tbl_nca_reviewmateriel` (
