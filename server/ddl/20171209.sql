...
/* tiny */
ALTER TABLE `tbl_nca_produceprocess`
ADD COLUMN `process_description` varchar(200) AFTER `updated_at`;
/*end tiny */


/* nie */
ALTER TABLE tbl_nca_order modify order_address varchar(300) NULL;
ALTER TABLE tbl_nca_order modify produce_id bigint(20) NULL;
/*end nie */

/* HLQ */
--DROP TABLE IF EXISTS `tbl_nca_zoweeprocess`;
--CREATE TABLE `tbl_nca_zoweeprocess` (
...
/* LJZ */
--DROP TABLE IF EXISTS `tbl_nca_taskallotuser`;
--CREATE TABLE `tbl_nca_taskallotuser` (
...
/* LJZ */
--DROP TABLE IF EXISTS `tbl_nca_taskallot`;
--CREATE TABLE `tbl_nca_taskallot` (
...
--
--BEGIN;
--INSERT INTO `tbl_nca_taskallot` VALUES ('1', '一般任务', '', '1', '0', '2017-12-06 09:40:21', '2017-12-06 09:40:24'), ('2', '采购申请', '', '1', '0', '2017-12-06 09:40:55', '2017-12-06 09:41:00'), ('3', '内部审核', '', '1', '0', '2017-12-06 09:41:25', '2017-12-06 09:41:30'), ('4', '生产计划', '', '1', '0', '2017-12-06 09:41:46', '2017-12-06 09:41:49'), ('5', '订单评审', '', '1', '0', '2017-12-06 09:42:02', '2017-12-06 09:42:05'), ('6', '订单验收', '', '1', '0', '2017-12-06 09:42:15', '2017-12-06 09:42:18'), ('7', '物料审核', '', '1', '0', '2017-12-06 09:42:30', '2017-12-06 09:42:36');
--COMMIT;
