...
/* qm */
DROP TABLE IF EXISTS `tbl_nca_productplan`;
CREATE TABLE `tbl_nca_productplan` (
...
DROP TABLE IF EXISTS `tbl_nca_productplandetail`;
CREATE TABLE `tbl_nca_productplandetail` (
...
DROP TABLE IF EXISTS `tbl_nca_productplanrelated`;
CREATE TABLE `tbl_nca_productplanrelated` (
...
DROP TABLE IF EXISTS `tbl_nca_productplanprocedure`;
CREATE TABLE `tbl_nca_productplanprocedure` (
...
DROP TABLE IF EXISTS `tbl_nca_productionprocedure`;
CREATE TABLE `tbl_nca_productionprocedure` (
...
call Pro_AddMenu('生产计划管理', '生产工序管理', '/nca/productionmanage/NCAProductProcedureControl', 'NCAPRODUCTPROCEDURECONTROL');
call Pro_AddMenu('生产计划管理', '产品规划', '/nca/productionmanage/NCAProductPlanControl', 'NCAPRODUCTPLANCONTROL');
