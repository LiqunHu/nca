...
/* jjs */
    ...
    DROP TABLE IF EXISTS `tbl_nca_salereceivables`;
    CREATE TABLE `tbl_nca_salereceivables` (
...
ALTER TABLE `tbl_nca_customer` ADD COLUMN `customer_reimburserank_id` bigint(20) NUll AFTER `goupload_format`;
/*end ty */
