...
/* ls */
    ...
    ALTER TABLE `tbl_nca_askforleave` ADD COLUMN `askforleave_checker_id` varchar(30) NUll AFTER `check_time`;
    ALTER TABLE `tbl_nca_askforleave` ADD COLUMN `askforleave_refuse_remark` varchar(300) NUll AFTER `askforleave_checker_id`;
...
/* hlq */
DROP TABLE IF EXISTS `tbl_nca_roomtype`;
CREATE TABLE `tbl_nca_roomtype` (
