...
/* ls */
DROP TABLE IF EXISTS `tbl_nca_notice`;
CREATE TABLE `tbl_nca_notice` (
...
DROP TABLE IF EXISTS `tbl_nca_notice_org`;
CREATE TABLE `tbl_nca_notice_org` (
...
DROP TABLE IF EXISTS `tbl_nca_notice_user`;
CREATE TABLE `tbl_nca_notice_user` (
