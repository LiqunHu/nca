...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_invalidateorder`;
CREATE TABLE `tbl_nca_invalidateorder` (
...
/* LJZ */
DROP TABLE IF EXISTS `tbl_nca_invalidateApplyorder`;
CREATE TABLE `tbl_nca_invalidateApplyorder` (
...
ALTER TABLE `tbl_nca_stockapplyitem`
...
/* ls */
call Pro_AddMenu('运营数据管理', '工人维护', '/nca/baseconfig/NCAWorkerControl', 'NCAWORKERCONTROL');
