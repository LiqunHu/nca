...
const logger = require('../../../util/Logger').createLogger('NCALoanControlSRV');
const model = require('../../../model');

const sequelize = model.sequelize;
const tb_loan = model.nca_loan;

exports.NCALoanControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr = 'select t.*,ut.`name`,ut.phone,ot.order_address,ot.order_house_area,ot.project_type ' +
            ...
            'left join tbl_nca_order ot on t.order_id = ot.order_id where t.domain_id=?'
