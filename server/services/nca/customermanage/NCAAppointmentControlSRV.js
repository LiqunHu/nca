...
const logger = require('../../../util/Logger').createLogger('NCAAppointmentControlSRV');
...
exports.NCAAppointmentControlResource = (req, res) => {
...
async function searchPhoneAct(req, res) {
    try {
        ...
        let queryStr = 'select * from tbl_common_user a, tbl_nca_customer b where a.user_id = b.user_id and a.phone like ? limit 0,6'
