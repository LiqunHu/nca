 ...
 */
const logger = require('../../../util/Logger').createLogger('NCACmsSRV');
const moment = require('moment');
const GLBConfig = require('../../../util/GLBConfig');
let Promise = require('bluebird');
let mongoose = require('./NCACmsModels').getMongo();
...
let typeEntity = require('./NCACmsModels').TypeEntity;
let typeModel = mongoose.model('cms_type', typeEntity);
let contentEntity = require('./NCACmsModels').ContentEntity;
...
exports.NCACmsResource = (req, res) => {
