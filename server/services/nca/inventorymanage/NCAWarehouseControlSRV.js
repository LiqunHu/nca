...
const logger = require('../../../util/Logger').createLogger('NCAWarehouseControlSRV');
...
exports.NCAWarehouseControlResource = (req, res) => {
...
let searchAct = async(req, res)=> {
    try {
        ...
        let queryStr = `select * from tbl_nca_warehouse where domain_id = ? and state = ? `;
