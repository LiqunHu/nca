...
exports.NCAStcokInApplyControlResource = (req, res) => {
...
async function getStockApplyDetailAct(req,res){
    try {
        ...
        from tbl_nca_stockapplyitem si
        left join tbl_nca_materiel m on (si.materiel_id=m.materiel_id)
