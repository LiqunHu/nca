...
const logger = require('../../../util/Logger').createLogger('NCAInventoryDetailControlSRV');
const model = require('../../../model');
const Sequence = require('../../../util/Sequence');
const moment = require('moment');
const sequelize = model.sequelize;
const tb_nca_inventoryaccount = model.nca_inventoryaccount;

exports.NCAInventoryDetailControlResource = (req, res) => {
...
let searchAct = async(req, res)=> {
    try {
        ...
        let queryStr = `select ia.*,m.materiel_code,m.materiel_name,m.materiel_format,m.materiel_unit from tbl_nca_inventoryaccount ia
        left join tbl_nca_materiel m on ia.materiel_id = m.materiel_id  
