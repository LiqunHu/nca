...
exports.NCASupplierMaterielControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr = `
            ...
            from tbl_nca_suppliermateriel sm
            left join tbl_nca_materiel m on sm.materiel_id = m.materiel_id
...
async function searchMat(req, res) {
    try {
        ...
        let queryStr = 'select * from tbl_nca_materiel where materiel_source in (2,3) and state = 1 and domain_id' + await FDomain.getDomainListStr(req);
