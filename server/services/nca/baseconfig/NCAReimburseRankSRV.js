...
const logger = require('../../../util/Logger').createLogger('NCAReimburseRankSRV');
...
exports.NCAReimburseRankResource = (req, res) => {
...
let searchAct = async(req, res)=> {
    try {
        ...
        let queryStr = 'select * from tbl_common_domain a left join tbl_nca_reimburserank b on a.domain_id = b.domain_id' +
