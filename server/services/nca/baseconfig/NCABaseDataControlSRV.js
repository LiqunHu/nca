...
const logger = require('../../../util/Logger').createLogger('NCABaseDataControlSRV');
...
const tb_position = model.nca_position;//岗位
...
// 基础数据管理接口
exports.NCABaseDataControlResource = async (req, res) => {
...
async function importMateriel(req,res) {
    try {
        ...
        // let queryStr = 'delete from tbl_nca_materiel where domain_id=?';
