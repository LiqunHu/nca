...
const logger = require('../../../util/Logger').createLogger('NCAVehicleManageControlSRV');
...
exports.NCAVehicleManageControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select t.* , ut.name as admin_user_name from tbl_nca_vehicle t ' +
