...
const logger = require('../../../util/Logger').createLogger('NCAPointControlSRV');
const model = require('../../../model');
const moment = require('moment');

const sequelize = model.sequelize;
const tb_pointtype = model.nca_pointtype;
const tb_point = model.nca_customerpoint;
const tb_customer = model.nca_customer;

exports.NCAPointControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let returnData = {};
        let replacements =[];
        let queryStr='select t.* from tbl_nca_customerpoint t where t.state=1';
        if (doc.search_text){
...
//更新客户积分
// user_id:客户id;
// pointtype_id：积分分类，对应tbl_nca_pointtype表中pointtype_id;
