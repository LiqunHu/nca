...
const logger = require('../../../util/Logger').createLogger('NCAPointTypeControlSRV');
...
exports.NCAPointTypeControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let returnData = {};
        let replacements =[];
        let queryStr='select t.* from tbl_nca_pointtype t where t.state=1';
        if (doc.search_text){
