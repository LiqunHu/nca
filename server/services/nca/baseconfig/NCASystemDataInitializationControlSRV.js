...
const logger = require('../../../util/Logger').createLogger('NCASystemDataInitializationControlSRV');
const model = require('../../../model');
const moment = require('moment');

const sequelize = model.sequelize;
const tb_user = model.common_user;
const tb_basetype = model.nca_basetype;
const tb_basetypedetail = model.nca_basetypedetail;

exports.NCASystemDataInitializationControlResource = (req, res) => {
...
async function initAct(req, res) {
    try {
        ...
        let queryStr = 'select t.basetype_code as id,t.basetype_name as text' +
            ' from tbl_nca_basetype t where state=1 ';
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select t.*,rt.basetype_code,rt.basetype_name from tbl_nca_basetypedetail t ' +
            'left join tbl_nca_basetype rt on t.basetype_id = rt.basetype_id ' +
