...
const logger = require('../../../util/Logger').createLogger('NCADepartmentControlSRV');
...
//行政办公管理->部门管理接口
exports.NCADepartmentControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select t.*,pt.department_name as p_department_name from tbl_nca_department t ' +
            'left join tbl_nca_department pt on t.p_department_id = pt.department_id ' +
