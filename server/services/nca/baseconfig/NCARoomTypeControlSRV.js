...
const logger = require('../../../util/Logger').createLogger('NCARoomTypeControlSRV');
...
exports.NCARoomTypeControlResource = (req, res) => {
...
async function searchRoomType(req, res) {
    try {
        ...
        let queryStr = 'select * from tbl_nca_roomtype where state=1';
        if (doc.estateId) {
