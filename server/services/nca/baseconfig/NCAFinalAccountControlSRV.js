...
//工程项目管理->项目决算列表
exports.NCAFinalAccountControlResource = (req, res) => {
    let method = req.query.method;
    if (method === 'init') {
        NCAProjectControlSRV.initAct(req, res)
    } else if (method === 'search'){
        NCAProjectControlSRV.searchAct(req, res)
    } else if (method === 'search_detail'){
        NCAProjectControlSRV.searchDetailAct(req, res)
    } else if (method === 'search_space_detail'){
        NCAProjectControlSRV.searchSpaceDetailAct(req, res)
    } else if (method === 'modify_space'){
        NCAProjectControlSRV.modifySpaceAct(req, res)
