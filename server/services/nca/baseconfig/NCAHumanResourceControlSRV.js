...
const logger = require('../../../util/Logger').createLogger('NCAHumanResourceControlSRV');
...
//人力资源管理->人力需求列表
exports.NCAHumanResourceControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select t.*,ut.username,gt.usergroup_name,dt.department_name,pt.position_name from tbl_nca_humanresource t ' +
            ...
            'left join tbl_nca_position pt on t.position_id = pt.position_id and pt.state=1 ' +
