...
exports.NCATransReceptionResource = (req, res) => {
...
let searchAct = async (req, res) => {
    try {
        ...
        let queryStr = 'select * from tbl_common_domain a left join tbl_nca_transreceptionapply b ' +
...
let addAct = async (req, res) => {
    try {
        ...
        logger.error('NCATransReceptionResource-addAct:' + error);
        common.sendFault(res, error);
    }
};
...
let removeAct = async (req, res) => {
    try {
        ...
        logger.error('NCATransReceptionResource-removeAct:' + error);
        common.sendFault(res, error);
    }
};
