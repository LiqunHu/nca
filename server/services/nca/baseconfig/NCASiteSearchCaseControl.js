...
const tb_sitecase = model.nca_sitecase;
const sequelize = model.sequelize;
const tb_uploadfile = model.nca_uploadfile;

exports.NCASiteSearchCaseControl = (req, res) => {
...
async function searchCase(req, res) {
    try {
        ...
        let returnData = {};
        let replacements = [];
        let api_name = 'NCASITECONFIGCASECONTROL'
        let queryStr = `select * from tbl_nca_sitecase where state = 1 `;
