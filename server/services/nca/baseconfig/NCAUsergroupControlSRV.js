...
const logger = require('../../../util/Logger').createLogger('NCAUsergroupControlSRV');
...
exports.NCAUsergroupControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select t.*,dt.department_id,dt.department_name,pt.position_name as p_position_name,gt.usergroup_name from tbl_nca_position t ' +
            'left join tbl_nca_position pt on t.p_position_id=pt.position_id ' +
