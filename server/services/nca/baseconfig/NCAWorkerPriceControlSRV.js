...
const logger = require('../../../util/Logger').createLogger('NCAWorkerPriceControlSRV');
...
exports.NCAWorkerPriceControlResource = (req, res) => {
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr='select * from tbl_nca_workerprice where domain_id = ? and state = 1'
