...
const logger = require('../../../util/Logger').createLogger('NCAMessageListControlSRV');
const model = require('../../../model');
const moment = require('moment');

const sequelize = model.sequelize;
//系统管理->消息管理
exports.NCAMessageListControlResource = (req, res) => {
...
async function searchReceiveAct(req, res) {
    try {
        ...
        //通知
        let queryStr = 'select t.*,st.username from tbl_nca_message_user t ' +
