...
const logger = require('../../../util/Logger').createLogger('NCALandAgentControlSRV');
...
// 地产商接口
exports.NCALandAgentControlResource = (req, res) => {
            ...
            where: {
                ...
                api_function: {
                    $in: [
                        'NCAESTATECONTROL',
                        'NCAROOMTYPECONTROL',
                        'NCALANDAGENTESTATECONTROL',
                        'NCALANDAGENTORDERCONTROL',
                        'USERSETTING',
                        'RESETPASSWORD']
                }
            }
...
async function searchAct(req, res) {
    try {
        ...
        let queryStr = `select l.*,d.domain_name from tbl_nca_landagent l
