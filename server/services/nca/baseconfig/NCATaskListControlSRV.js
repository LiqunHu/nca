...
const logger = require('../../../util/Logger').createLogger('NCATaskListControlSRV');
const model = require('../../../model');
const Sequence = require('../../../util/Sequence');
const WeeklyPlanControlSRV = require('../productionmanage/NCAWeeklyPlanControlSRV');
const PurchaseApplyDetailControlSRV = require('../purchasemanage/NCAPurchaseApplyDetailControlSRV');
const NCAMaterielCrmControlSRV = require('../ordermanage/NCAMaterielCrmControlSRV');
const NCAInvalidateControlSRV = require('../inventorymanage/NCAInvalidateControlSRV');
const NCAProjectControlSRV = require('./NCAProjectControlSRV');
const NCANoticeControlSRV = require('./NCANoticeControlSRV');
const NCAHumanResourceControlSRV = require('./NCAHumanResourceControlSRV');
const NCAQualityAddControlSRV = require('../purchasemanage/NCAQualityAddControlSRV');
const NCAInventoryControlSRV = require('../inventorymanage/NCAInventoryControlSRV');
const NCATransReceptionDetailSRV = require('../baseconfig/NCATransReceptionDetailSRV');
const NCATransReceptionExpenseDetailSRV = require('../baseconfig/NCATransReceptionExpenseDetailSRV');
const NCADocumentManagementControlSRV = require('../baseconfig/NCADocumentManagementControlSRV');
const NCAAskForLeaveControlSRV = require('../baseconfig/NCAAskForLeaveControlSRV');
const NCASpecialExpenseControl = require('../baseconfig/NCASpecialExpenseControl');
const NCAFixedAssetsControlSRV = require('../longtermassets/NCAFixedAssetsControlSRV');
const NCAAmortizeControlSRV = require('../longtermassets/NCAAmortizeControlSRV');
const NCAAmortizeDetailControlSRV = require('../longtermassets/NCAAmortizeDetailControlSRV');
const NCADevelopControlSRV = require('../longtermassets/NCADevelopControlSRV');
const NCADevelopDetailControlSRV = require('../longtermassets/NCADevelopDetailControlSRV');
const NCAConsumablesDetailControlSRV = require('../longtermassets/NCAConsumablesDetailControlSRV');
const NCAAssetRetirementControlSRV = require('../longtermassets/NCAAssetRetirementControlSRV');
const NCAProductPlanControlSRV = require('../baseconfig/NCAProductPlanControlSRV');
const sms = require('../../../util/SMSUtil.js');

const sequelize = model.sequelize;
const Op = sequelize.Op;
const tb_task = model.nca_task;
const tb_user = model.common_user;
const tb_nca_orderreview = model.nca_orderreview;
const tb_reviewmateriel = model.nca_reviewmateriel;
const tb_materiel = model.nca_materiel;
const tb_invalidateorder = model.nca_invalidateorder;
const tb_invalidateApplyorder = model.nca_invalidateApplyorder;
const tb_stockitem = model.nca_stockitem; //安全库存明细
const tb_stockmap = model.nca_stockmap;
const tb_stockapply = model.nca_stockapply;
const tb_stockapplyitem = model.nca_stockapplyitem;
const tb_otherstockorder = model.nca_otherstockorder;
const tb_stockoutapply = model.nca_stockoutapply;
const tb_stockoutapplydetail = model.nca_stockoutapplydetail;
const tb_otherstockout = model.nca_otherstockout;
const tb_notice = model.nca_notice;
const tb_humanresource = model.nca_humanresource;
const tb_return = model.nca_return;
const tb_meetingattendee = model.nca_meetingattendee;
const tb_meeting = model.nca_meeting;
const tb_docuserstate = model.nca_docuserstate;
const tb_fixedassetsrepair = model.nca_fixedassetsrepair;
const tb_cashiergathering = model.nca_cashiergathering;
const tb_paymentconfirm = model.nca_paymentconfirm;
const tb_longassettakestock = model.nca_longassettakestock; //资产盘点管理列表
const tb_longassettakestockdetail = model.nca_longassettakestockdetail; //资产盘点管理详情
const tb_corporateclients = model.nca_corporateclients; //企业客户
const tb_creditlinedetail = model.nca_creditlinedetail; //信用额度明细
const tb_taskallot = model.nca_taskallot;
const tb_taskallotuser = model.nca_taskallotuser;
const tb_message_user = model.nca_message_user;
const tb_notice_user = model.nca_notice_user;
const tb_customtaskallot = model.nca_customtaskallot;
const tb_supremetask = model.nca_supremetask;
const tb_uploadfile = model.nca_uploadfile;

exports.NCATaskListControlResource = (req, res) => {
...
let searchAct = async (req, res) => {
  try {
    let doc = common.docTrim(req.body),
      user = req.user,
      returnData = {};
    let queryStr = `select t.*, f.file_url, u.avatar from tbl_nca_task t
    LEFT JOIN tbl_nca_supremetask s ON t.task_group = s.task_group
    LEFT JOIN tbl_nca_uploadfile f ON s.supremetask_id = f.order_id AND f.state = 1
...
let completeAct = async (req, res) => {
  try {
    ...
    if (task.task_type === '5') { //修改订单评审的状态为'完成'
      let review = await tb_nca_orderreview.findOne({
        where: {
  ...
  try {
    ...
    if (reviewResult == 1) {
      ...
      if (maxLev && task.taskallotuser_level < maxLev) {
        ...
        let qStr = `select * from tbl_nca_taskallotuser t,tbl_common_user u
        ...
        let nextStr = `select * from tbl_nca_taskallotuser t,tbl_common_user u
    ...
    // //预算审核任务和决算审核任务
    // if (reviewType === '13') {
    //   await NCAProjectControlSRV.reviewProjectlTask(reviewResult, reviewType, task.task_review_code, doc.task_remark);
    // }
    if (reviewResult == 1) {
      if (reviewType === '2') {
        ...
        await NCAMaterielCrmControlSRV.reviewMaterialTask(user, '2', task.review_id, doc.task_remark)
      } else if (reviewType === '9') {
        let queryStrApply = 'select * from tbl_nca_invalidateapplyorder where state = 1 and invalidateorder_id = ?';
        ...
        await NCANoticeControlSRV.modifyNoticeState('3', doc.task_remark, task.task_review_code, user.user_id);
        ...
        await NCAHumanResourceControlSRV.modifyHRState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '16') {
        await NCAQualityAddControlSRV.modifyReturnState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '17') {
        await NCAInventoryControlSRV.updateIdleApply('1', task.review_id, task.task_review_code, task.task_performer, user.domain_id);
      } else if (reviewType === '22') {
        await NCATransReceptionDetailSRV.modifyTransApplyState('2', doc.task_remark, task.task_review_code, user.user_id, user.domain_id);
      } else if (reviewType === '25') {
        await NCADocumentManagementControlSRV.modifyDocumentState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '27') {
        await NCAAskForLeaveControlSRV.modifyAskForLeaveState('2', doc.task_remark, task.task_review_code, user.user_id);
        ...
        await NCASpecialExpenseControl.modifySpecialEpenseState('2', doc.task_remark, task.task_review_code, user.user_id, user.domain_id, user, taskallotuser);
      } else if (reviewType === '29') {
        await NCAFixedAssetsControlSRV.modifyFixedAssetsPurchState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '30') {
        await NCAFixedAssetsControlSRV.modifyFixedAssetsCheckState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '32') {
        await NCAAmortizeControlSRV.modifyAmortizeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '33') {
        await NCAAmortizeDetailControlSRV.modifyBudgetState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '34') {
        await NCAAmortizeDetailControlSRV.modifySubscribeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '35') {
        await NCAAmortizeDetailControlSRV.modifyReceiveState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '37') {
        await NCAAmortizeDetailControlSRV.modifyConsumeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '36') {
        await NCAAmortizeDetailControlSRV.modifyClearingState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '39') {
        await NCAAssetRetirementControlSRV.modifyScrapState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '38') {
        await NCAAmortizeDetailControlSRV.modifyCostState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '40') {
        await NCAConsumablesDetailControlSRV.modifyConsumableState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '41') {
        await NCAConsumablesDetailControlSRV.modifyConsumableState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '42') {
        await NCAAmortizeDetailControlSRV.modifyCheckState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '50') {
        await NCADevelopControlSRV.modifyDevelopState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '51') {
        await NCADevelopDetailControlSRV.modifyBudgetState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '52') {
        await NCADevelopDetailControlSRV.modifySubscribeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '53') {
        await NCADevelopDetailControlSRV.modifyReceiveState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '55') {
        await NCADevelopDetailControlSRV.modifyConsumeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '54') {
        await NCADevelopDetailControlSRV.modifyClearingState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '56') {
        await NCADevelopDetailControlSRV.modifyCostState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '57') {
        await NCADevelopDetailControlSRV.modifyCheckState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '60') {
        await NCAProjectControlSRV.modifySubscribeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '61') {
        await NCAProjectControlSRV.modifyClearingState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '62') {
        await NCAProjectControlSRV.modifyConsumeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '63') {
        await NCAProjectControlSRV.modifyCostState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '64') {
        await NCAProjectControlSRV.modifyCheckState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '65') {
        await NCAProjectControlSRV.modifyProjectState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '66') {
        await NCAProjectControlSRV.modifyBudgetState('2', doc.task_remark, task.task_review_code, user.user_id);
      }
      ...
      if (reviewType === '2') {
        ...
        await NCAMaterielCrmControlSRV.reviewMaterialTask(user, '1', task.review_id, doc.task_remark)
      } else if (reviewType === '9') {
        let invalidateorder = await tb_invalidateorder.findOne({
          where: {
            invalidateorder_id: task.task_review_code,
        ...
        await NCANoticeControlSRV.modifyNoticeState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '17') {
        await NCAInventoryControlSRV.updateIdleApply('0', task.review_id, task.task_review_code, task.task_performer, user.domain_id, task.task_remark);
      } else if (reviewType === '22') {
        await NCATransReceptionDetailSRV.modifyTransApplyState('3', doc.task_remark, task.task_review_code, user.user_id, user.domain_id);
      } else if (reviewType === '25') {
        await NCADocumentManagementControlSRV.modifyDocumentState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '27') {
        await NCAAskForLeaveControlSRV.modifyAskForLeaveState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '28') {
        //校验是否分配任务处理人员
        let taskallot = await tb_taskallot.findOne({
          where: {
        ...
        await NCASpecialExpenseControl.modifySpecialEpenseState('3', doc.task_remark, task.task_review_code, user.user_id, user.domain_id, user);
      } else if (reviewType === '29') {
        await NCAFixedAssetsControlSRV.modifyFixedAssetsPurchState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '30') {
        await NCAFixedAssetsControlSRV.modifyFixedAssetsCheckState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '32') {
        await NCAAmortizeControlSRV.modifyAmortizeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '33') {
        await NCAAmortizeDetailControlSRV.modifyBudgetState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '34') {
        await NCAAmortizeDetailControlSRV.modifySubscribeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '35') {
        await NCAAmortizeDetailControlSRV.modifyReceiveState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '37') {
        await NCAAmortizeDetailControlSRV.modifyConsumeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '36') {
        await NCAAmortizeDetailControlSRV.modifyClearingState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '39') {
        await NCAAssetRetirementControlSRV.modifyScrapState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '38') {
        await NCAAmortizeDetailControlSRV.modifyCostState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '40') {
        await NCAConsumablesDetailControlSRV.modifyConsumableState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '41') {
        await NCAConsumablesDetailControlSRV.modifyConsumableState('2', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '42') {
        await NCAAmortizeDetailControlSRV.modifyCheckState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '50') {
        await NCADevelopControlSRV.modifyDevelopState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '51') {
        await NCADevelopDetailControlSRV.modifyBudgetState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '52') {
        await NCADevelopDetailControlSRV.modifySubscribeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '53') {
        await NCADevelopDetailControlSRV.modifyReceiveState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '55') {
        await NCADevelopDetailControlSRV.modifyConsumeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '54') {
        await NCADevelopDetailControlSRV.modifyClearingState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '56') {
        await NCADevelopDetailControlSRV.modifyCostState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '57') {
        await NCADevelopDetailControlSRV.modifyCheckState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '60') {
        await NCAProjectControlSRV.modifySubscribeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '61') {
        await NCAProjectControlSRV.modifyClearingState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '62') {
        await NCAProjectControlSRV.modifyConsumeState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '63') {
        await NCAProjectControlSRV.modifyCostState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '64') {
        await NCAProjectControlSRV.modifyCheckState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '65') {
        await NCAProjectControlSRV.modifyProjectState('3', doc.task_remark, task.task_review_code, user.user_id);
      } else if (reviewType === '66') {
        await NCAProjectControlSRV.modifyBudgetState('3', doc.task_remark, task.task_review_code, user.user_id);
      }
    ...
    //在工作流中的审核，修改同组人的任务状态为'完成'
    let queryStr = `select * from tbl_nca_taskallotuser t,tbl_common_user u
                              where t.user_id=u.user_id and t.state=1 and u.state=1
    ...
    if (task.task_type === '8' || task.task_type === '12' || task.task_type === '13' ||
      ...
      switch (task.task_type) {
        ...
        case '72':
        case '73':
          await NCAProductPlanControlSRV.productPlanVerified(user, task.task_type, task.task_review_code);
          break;
      }
    }
...
async function getFlowAct(req, res) {
  try {
    ...
    tbl_nca_taskallotuser u
    left join tbl_nca_task t on t.domain_id = u.domain_id
...
let getPublicTaskAct = async (req, res) => {
    try {
        let doc = common.docTrim(req.body),
            user = req.user,
            returnData = {};
        let queryStr = `select t.*, f.file_url, u.avatar from tbl_nca_supremetask t
        LEFT JOIN tbl_nca_uploadfile f ON t.supremetask_id = f.order_id and  f.state = 1
