...
const logger = require('../../../util/Logger').createLogger('NCAPaymentConfirmControlSRV');
...
const paymentconfirm = model.nca_paymentconfirm;
const tb_user = model.common_user;
const tbl_corporateclients = model.nca_corporateclients;

exports.NCAPaymentConfirmControlResource = (req, res) => {
