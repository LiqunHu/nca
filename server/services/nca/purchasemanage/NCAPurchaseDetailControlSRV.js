...
const logger = require('../../../util/Logger').createLogger('NCAPurchaseDetailControlSRV');
...
// 采购单明细接口
exports.NCAPurchaseDetailControlResource = (req, res) => {
...
async function search(req,res){
    ...
    let queryStr=`select m.*,a.purchasedetail_id,a.purchase_number,a.purchase_price,(a.purchase_number*a.purchase_price) as purchase_money,a.order_ids
         ...
         left join tbl_nca_materiel m on a.materiel_id=m.materiel_id  
         where a.state=1 `;
...
async function getpuchaseOrderPrint(req,res){
    ...
    try{
        ...
        queryStr=`select m.*,pd.purchase_number from tbl_nca_purchasedetail pd 
