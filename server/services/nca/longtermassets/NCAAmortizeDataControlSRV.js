...
const logger = require('../../../util/Logger').createLogger('NCAAmortizeDataControlSRV');
...
exports.NCAAmortizeDataControlResource = (req, res) => {
...
// 文件上传至mongoDB，并将路径等信息保存tbl_nca_uploadfile
