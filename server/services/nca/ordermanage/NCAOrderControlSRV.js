...
const logger = require('../../../util/Logger').createLogger('NCAOrderControlSRV');
...
const tb_pointtype = model.nca_pointtype;

const fs = require('fs');
const path = require('path');
const iconvLite = require('iconv-lite');
const config = require('../../../config');
exports.NCAOrderControlResource = (req, res) => {
...
let initAct = async(req, res) => {
    ...
    queryStr = `select distinct u.user_id,u.name from tbl_nca_order o 
    left join tbl_common_user u on (o.purchaser_user_id=u.user_id and u.state=1) 
