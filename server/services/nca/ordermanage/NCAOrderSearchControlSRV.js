...
const logger = require('../../../util/Logger').createLogger('NCAOrderSearchControlSRV');
...
// 酷家乐对接接口
exports.NCAOrderSearchControlResource = (req, res) => {
...
let search_order = async (req, res) => {
    try {
        ...
        let queryStr = `select o.*,u.*, e.*, r.*, k.*, o.order_id order_id, o.domain_id domain_id,
                ...
                left join tbl_nca_estate e on e.estate_id = o.estate_id
                left join tbl_nca_roomtype r on o.roomtype_id = r.roomtype_id
                left join tbl_nca_orderkujiale k on o.order_id = k.order_id
